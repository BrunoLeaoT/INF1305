...
var routes = [
    { path: '', loadChildren: './tabs/tabs.module#TabsPageModule' }, { path: 'details/:id', loadChildren: './pages/todo-details/todo-details.module#TodoDetailsPageModule' },
...
/* harmony import */ var _service_methods__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./service/methods */ "./src/app/service/methods.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _service_methods__WEBPACK_IMPORTED_MODULE_13__["Methods"]
            ],
...
window.addEventListener('load', function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
    var error_1;
    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!window.ethereum) return [3 /*break*/, 5];
                window.web3 = new web3__WEBPACK_IMPORTED_MODULE_1__(ethereum);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
if (typeof web3 !== 'undefined') {
    web3 = new web3__WEBPACK_IMPORTED_MODULE_1__(web3.currentProvider);
}
else {
    // set the provider you want from Web3.providers
    web3 = new web3__WEBPACK_IMPORTED_MODULE_1__(new web3__WEBPACK_IMPORTED_MODULE_1__["providers"].HttpProvider('http://localhost:8100'));
}
var defaultAccount;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _contrato__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contrato */ "./src/app/service/contrato.js");
/* harmony import */ var angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! angularfire2/firestore */ "./node_modules/angularfire2/firestore/index.js");
/* harmony import */ var angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_web3__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/web3 */ "./src/app/service/web3.js");
...
var Methods = /** @class */ (function () {
    ...
    Methods.prototype.ionViewDidLoad = function () {
    };
    Methods.prototype.criarEmpresa = function (nome, address) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                _contrato__WEBPACK_IMPORTED_MODULE_1__["default"].methods.criarEmpresa(nome, address).send({ from: _contrato__WEBPACK_IMPORTED_MODULE_1__["default"]._defaultAccount }).then(console.log);
                return [2 /*return*/];
            });
        });
    };
    Methods.prototype.criarLog = function (nome, consciente, data) {
        var bool = false;
        if (consciente == "true")
            bool = true;
        this.pegarAddressEmpresa(nome).then(function (dado) {
            _contrato__WEBPACK_IMPORTED_MODULE_1__["default"].methods.criarLog(dado, bool, data, false).send({ from: dado })
                .then(console.log);
        });
    };
    Methods.prototype.verificarLog = function (nome, consciente, data) {
        var _this = this;
        var bool = false;
        if (consciente == "true")
            bool = true;
        this.pegarAddressEmpresa(nome)
            .then(function (dado) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                _service_web3__WEBPACK_IMPORTED_MODULE_4__["default"].eth.getAccounts().then(function (add) {
                    _contrato__WEBPACK_IMPORTED_MODULE_1__["default"].methods.verificarLog(dado, bool, data).send({ from: add[0] })
                        .then(console.log);
                });
                return [2 /*return*/];
            });
    ...
    Methods.prototype.getEmpresa = function (empresaRequesitada) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var address;
                        _this.pegarAddressEmpresa(empresaRequesitada)
                            .then(function (data) {
                            address = data;
                            _contrato__WEBPACK_IMPORTED_MODULE_1__["default"].methods.getLogs(address).call().then(function (logs) {
                                console.log(logs);
                                return resolve(logs);
                            });
                        })
    ...
    Methods.prototype.pegarAddressEmpresa = function (empresa) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.db.collection("agentes").get().toPromise().then(function (snapshot) {
    ...
    Methods = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyAL1JxT61TENylDIQwyfG3XeqGcU_KzHuI",
        authDomain: "pescaconsciente-b5520.firebaseapp.com",
        databaseURL: "https://pescaconsciente-b5520.firebaseio.com",
        projectId: "pescaconsciente-b5520",
        storageBucket: "pescaconsciente-b5520.appspot.com",
        messagingSenderId: "604791578979"
    }
};
/*
...
module.exports = __webpack_require__(/*! /Users/brunoleaoteixeira/Documents/Projetos/Bycatch/INF1305/src/main.ts */"./src/main.ts");
